...
const rows = [
  ...
  R('M_RABIT_ISHARA', 'اسْمُ إِشَارَةٍ رَابِطًا', CH.mubtada, '102', 'الرابط', 'اسْمُ إِشَارَةٍ',
    { requires: 'الرَّابِطُ', missingReason: 'RABIT_KINDS.ismIshara is declared with produced:false; the demonstrative link is never generated. باب النعت does now produce a demonstrative — as a mubtadaʾ, not as a link — which is why this row carries a `requires` discriminator: the two readings share a term and are not the same practice.' }),
