...
const rows = [
  ...
  R('T_NAAT_HAQIQI', 'النَّعْتُ الْحَقِيقِيُّ', CH.naat, '116–118', 'أقسام النعت', 'النَّعْتُ الْحَقِيقِيُّ'),
  ...
  R('B_MUNADA_MUDAF', 'الْمُضَافُ', CH.munada, '168–170', 'أقسام المنادى', 'الْمُنَادَى الْمُضَافُ'),
